      ...
      <div className="h-full overflow-scroll lg:flex" ref={containerRef}>
        ...
        <div className="p-4 sm:p-8 md:p-12 lg:p-20 xl:p-48 flex flex-col gap-24 md:gap-32 lg:gap-48 xl:gap-64 lg:w-2/3 lg:pr-0 xl:w-1/2">
          ...
          <div className="flex flex-col gap-12 justify-center">
            ...
            />
            {/* BIOGRAPHY TITLE */}
            <h1 className="font-bold text-2xl">About My Lawyer</h1>
            {/* BIOGRAPHY DESC */}
            <p className="text-lg">
            Are you facing legal challenges and seeking professional guidance 
            ...
            needs. With years of experience and a track record of success, our 
            team of dedicated attorneys is committed to advocating for your 
            rights and achieving the best possible outcome for your case. 
            Whether you are dealing with a personal injury matter, family 
            law issue, or business dispute, trust us to provide you with 
            the strategic counsel and representation you deserve.
            Contact us today to schedule a consultation and take the 
            first step towards resolving your legal concerns effectively.
            </p>
            {/* BIOGRAPHY QUOTE */}
            <span className="italic">
              - Your on the go lawyer.
            </span>
